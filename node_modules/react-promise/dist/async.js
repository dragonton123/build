...
/***/ (function(module, exports, __webpack_require__) {
	...
	Async.propTypes = {
	  before: _propTypes2.default.func, // renders it's return value before promise is handled
	  then: _propTypes2.default.func, // renders it's return value when promise is resolved
	  catch: _propTypes2.default.func, // renders it's return value when promise is rejected
	  pendingRender: _propTypes2.default.node, // renders it's value when promise is pending
	  promise: _propTypes2.default.object // promise itself
	};
