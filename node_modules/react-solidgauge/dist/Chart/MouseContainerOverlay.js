...
var PathGroup = function (_Component) {
  ...
  _createClass(PathGroup, [{
    ...
    key: 'appendSelect',
    value: function appendSelect() {
      var _this2 = this;

      var el = (0, _d3Selection.select)(this.container);
      el.selectAll('path.' + ch.MOUSE_PATH).on('click', function (d, i, p) {
        _this2.props.onSelect(p[i]);
      });
    }
  }, {
    key: 'appendHover',
    value: function appendHover() {
      ...
      el.selectAll('path.' + ch.MOUSE_PATH).on('mousemove', function (d, i, p) {
        ...
        var isBottom = pos[1] < _this3.props.height / 4;
        var _props$values$i = _this3.props.values[i],
        ...
        tool.transition().duration(50).attr('opacity', 1);
      });
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.values.map(function (d, i) {
          ...
          var thisArc = (0, _d3Shape.arc)().outerRadius(r).innerRadius(r - dim.marginAndWidth).startAngle(0).endAngle(_this4.props.endAngle);
